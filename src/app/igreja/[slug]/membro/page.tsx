    ...
    <div className="space-y-8">
      ...
      {video && (
        <section>
          ...
          {ctx.site.social_links?.youtube && (
            <a
              href={ctx.site.social_links.youtube}
              target="_blank"
              rel="noreferrer"
              className="mt-3 flex w-full items-center justify-center gap-2 rounded-[var(--radius)] bg-[#FF0000] px-4 py-2.5 text-sm font-semibold text-white"
            >
